...
export default function Home() {
  ...
  timerRef.current = setTimeout(() => {
    ...
    // Vibration (ne marchera que sur Android/Chrome)
  ...
  // FORCE L'ANIMATION LINÉAIRE (TWEEN) SANS AUCUN REBOND
  transition={{ 
    layout: { 
      type: "tween", 
      ease: "linear", 
  ...
  style={{ 
    ...
    userSelect: 'none',
    touchAction: 'pan-y' // Permet le scroll vertical sans interférer
  }} 
