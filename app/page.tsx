...
export default function Home() {
          ...
          <AnimatePresence mode="popLayout">
            {tasks.map((task) => (
              <motion.div 
                ...
                // RETRAIT DE transition-all ICI POUR ÉVITER LE BOUNCE
                className={`group w-full flex items-center p-5 border rounded-3xl select-none ${
  ...
  >
    ...
    >
      ...
      >
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="black" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-active:scale-110 transition-transform">
                ...
                <div className="space-y-3">
                  {shoppingList.map((ing, i) => {
                    ...
                    return (
                      ...
                      }} className={`flex justify-between items-center p-5 rounded-2xl border active:scale-95 ${isChecked ? 'bg-zinc-900 border-zinc-800 opacity-30' : 'bg-zinc-800 border-zinc-700'}`}>
